...
%This model says that an expansion of a centromere satellite that binds a centromeric histone protein, hypothesized to be Cid, creates more opportunities for microtubules to bind during meiosis.  However, this would create nondisjunction.  A second mutation, in the centromeric-binding histone protein, could then allow the weaker centromere to be bound more aggressively, restoring meiotic balance.  % expand 
