...
\subsection{Estimation of CentC Abundance} %Sid

%79 Zea mays CentC repeats were downloaded from ncbi nucleotide database.
%Used BLAST to align 79 queries with reference genome B73 version 3. Query file was built from all 79 CentC repeats concatenated into one header less file, reference genome B73 available from maizeGDB. 
%Used BWA mem to align BLAST outputs to Jiao inbred maize lines.
